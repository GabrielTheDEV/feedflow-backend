...
def send_slack_notification(
    ...
    Args:
        ...
        comment: Comentário do feedback
        metadata: Metadados adicionais
        image_url: URL da imagem (screenshot)
        webhook_url: URL do webhook específico do merchant (opcional, usa variável de ambiente se não fornecido)
    """
    # Se não foi fornecido webhook_url, tenta pegar da variável de ambiente (backward compatibility)
    if not webhook_url:
